...
const variants = {
  ...
  "amber-subtle":
    "bg-[#fff450] dark:bg-[#36190050] text-[#aa4d00] dark:text-[#ff9300] fill-[#aa4d00] dark:fill-[#ff9300]",
  red: "bg-[#fc0035] text-white fill-white",
  "red-subtle":
    "bg-[#ffe8ea] dark:bg-[#440d1350] text-[#d8001b] dark:text-[#ff565f] fill-[#d8001b] dark:fill-[#ff565f]",
